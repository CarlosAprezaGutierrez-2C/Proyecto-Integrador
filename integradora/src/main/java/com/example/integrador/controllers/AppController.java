...
import com.example.integrador.Models.Producto;
import com.example.integrador.services.ProductService;
...
public class AppController {
    ...
    private void abrirFormulario(Producto producto) {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/integrador/views/Form-view.fxml"));
